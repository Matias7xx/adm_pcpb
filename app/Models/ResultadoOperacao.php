...
class ResultadoOperacao extends Model
{
    ...
    {
        $total = $this->total_mandados_cumpridos + $this->total_mandados_nao_cumpridos;
    ...
    public function getEstatisticas()
    {
        return [
            ...
            'mandados_busca_infrator_cumpridos' => $this->mandados_busca_infrator_cumpridos,
            'mandados_busca_infrator_nao_cumpridos' => $this->mandados_busca_infrator_nao_cumpridos,
            'prisoes_flagrante' => $this->prisoes_flagrante,
            'total_prisoes' => $this->mandados_prisao_cumpridos + $this->prisoes_flagrante,
