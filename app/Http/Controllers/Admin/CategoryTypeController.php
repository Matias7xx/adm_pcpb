...
class CategoryTypeController extends Controller
{
  ...
  public function store(
    CategoryTypeCreateData $data,
    CategoryTypeCreateAction $categoryTypeCreateAction,
  ) {
    $this->authorize('adminCreate', CategoryType::class);
    $categoryTypeCreateAction->handle($data);

    return redirect()
      ->route('admin.category.type.index')
  ...
  public function update(
    CategoryTypeUpdateData $data,
    CategoryType $type,
    CategoryTypeUpdateAction $categoryTypeUpdateAction,
  ) {
    $this->authorize('adminUpdate', $type);
