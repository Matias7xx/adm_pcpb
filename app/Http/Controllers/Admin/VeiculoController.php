...
class VeiculoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $request->validate([
            ...
            'sort' => 'nullable|in:titulo,data_publicacao,data_expiracao,downloads,ordem',
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'dias_exibicao.required' => 'Informe por quantos dias o documento ficará visível.',
            'dias_exibicao.min' => 'O documento deve ficar visível por pelo menos 1 dia.',
            'dias_exibicao.max' => 'O documento não pode ficar visível por mais de 365 dias.',
            'data_publicacao.after_or_equal' => 'A data de publicação não pode ser anterior a hoje.',
        ...
        try {
            ...
            Storage::disk('s3')->put($caminhoArquivo, file_get_contents($file), 'public');
            ...
            return redirect()
                ->back()
                ->withErrors(['error' => 'Erro ao adicionar lista de veículos. Tente novamente.'])
                ->withInput();
        }
    }
    ...
    public function update(Request $request, Veiculo $veiculo)
    {
        ...
        try {
            $dados = [
                ...
                'descricao' => $request->descricao,
                'dias_exibicao' => $request->dias_exibicao,
                'data_publicacao' => $request->data_publicacao ?? $veiculo->data_publicacao,
            ...
            if ($request->hasFile('arquivo')) {
                ...
                if ($veiculo->arquivo && Storage::disk('s3')->exists($veiculo->caminho_arquivo)) {
            ...
            Log::error('Erro ao atualizar documento de veículo: ' . $e->getMessage(), [
            ...
            return redirect()
                ->back()
                ->withErrors(['error' => 'Erro ao atualizar lista de veículos. Tente novamente.'])
                ->withInput();
        }
    }
    ...
    public function destroy(Veiculo $veiculo)
    {
        try {
            ...
            return redirect()
                ->back()
                ->withErrors(['error' => 'Erro ao remover lista de veículos. Tente novamente.']);
        }
    }
    ...
    public function atualizarOrdem(Request $request)
    {
        ...
        try {
            ...
            Log::error('Erro ao atualizar ordem dos documentos: ' . $e->getMessage(), [
                'exception' => $e,
                'user_id' => auth()->id(),
            ]);
