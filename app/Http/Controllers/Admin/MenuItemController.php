...
class MenuItemController extends Controller
{
  ...
  public function create(Menu $menu)
  {
    ...
    return Inertia::render(
      ...
      compact('menu', 'itemOptions', 'roles'),
    );
  }
  ...
  public function store(
    MenuItemCreateData $data,
    Menu $menu,
    MenuItemCreateAction $menuItemCreateAction,
  ) {
    $this->authorize('adminCreate', MenuItem::class);
    $menuItemCreateAction->handle($data, $menu);

    return redirect()
      ->route('admin.menu.item.index', $menu->id)
  ...
  public function edit(Menu $menu, MenuItem $item)
  {
    ...
    $itemOptions = MenuItem::selectOptions(
      $menu->id,
    ...
    return Inertia::render(
      ...
      compact('menu', 'item', 'itemOptions', 'roles', 'itemHasRoles'),
    );
  }
  ...
  public function update(
    MenuItemUpdateData $data,
    Menu $menu,
    MenuItem $item,
    MenuItemUpdateAction $menuItemUpdateAction,
  ) {
    $this->authorize('adminUpdate', $item);
