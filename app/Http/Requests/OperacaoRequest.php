...
class OperacaoRequest extends FormRequest
{
  ...
  public function messages(): array
  {
    return [
      ...
      'horario_briefing.date_format' =>
        'Formato de horário inválido. Use HH:MM.',

      'quantidade_total_alvos.required' =>
        'A quantidade total de alvos é obrigatória.',
      'quantidade_total_alvos.integer' =>
        'A quantidade total de alvos deve ser um número inteiro.',
      'quantidade_total_alvos.min' =>
        'A quantidade total de alvos não pode ser negativa.',

      'quantidade_mandados_prisao.required' =>
        'A quantidade de mandados de prisão é obrigatória.',
      'quantidade_mandados_prisao.integer' =>
        'A quantidade de mandados de prisão deve ser um número inteiro.',
      'quantidade_mandados_prisao.min' =>
        'A quantidade de mandados de prisão não pode ser negativa.',

      'quantidade_mandados_busca_apreensao.required' =>
        'A quantidade de mandados de busca e apreensão é obrigatória.',
      'quantidade_mandados_busca_apreensao.integer' =>
        'A quantidade de mandados de busca e apreensão deve ser um número inteiro.',
      'quantidade_mandados_busca_apreensao.min' =>
        'A quantidade de mandados de busca e apreensão não pode ser negativa.',

      'quantidade_mandados_busca_apreensao_infrator.required' =>
        'A quantidade de mandados de busca e apreensão de infrator é obrigatória.',
      'quantidade_mandados_busca_apreensao_infrator.integer' =>
        'A quantidade deve ser um número inteiro.',
      'quantidade_mandados_busca_apreensao_infrator.min' =>
        'A quantidade não pode ser negativa.',

      'quantidade_alvos_outros_estados.required' =>
        'A quantidade de alvos em outros estados é obrigatória.',
      'quantidade_alvos_outros_estados.integer' =>
        'A quantidade deve ser um número inteiro.',
      'quantidade_alvos_outros_estados.min' =>
        'A quantidade não pode ser negativa.',

      'quantidade_policiais_empregados.required' =>
        'A quantidade de policiais empregados é obrigatória.',
      'quantidade_policiais_empregados.integer' =>
        'A quantidade deve ser um número inteiro.',
      'quantidade_policiais_empregados.min' =>
        'Deve haver pelo menos 1 policial empregado.',

      'quantidade_viaturas_empregadas.required' =>
        'A quantidade de viaturas empregadas é obrigatória.',
      'quantidade_viaturas_empregadas.integer' =>
        'A quantidade deve ser um número inteiro.',
      'quantidade_viaturas_empregadas.min' =>
        'A quantidade não pode ser negativa.',

      'cidades_alvo.required' =>
        'As cidades alvo da operação são obrigatórias.',
      'crimes_investigados.required' =>
        'Os crimes investigados são obrigatórios.',

      'vinculada_unidade.required' => 'A unidade vinculada é obrigatória.',
      'vinculada_unidade.in' => 'Unidade vinculada inválida.',

      'vinculada_unidade_especializada.required' =>
        'A unidade especializada vinculada é obrigatória.',
      'vinculada_unidade_especializada.in' => 'Unidade especializada inválida.',

      'outra_unidade_policial.required' =>
