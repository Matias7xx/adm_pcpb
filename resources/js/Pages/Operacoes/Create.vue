...
const form = useForm({
  ...
  quantidade_mandados_busca_apreensao:
    props.operacao?.quantidade_mandados_busca_apreensao || 0,
  quantidade_mandados_busca_apreensao_infrator:
    props.operacao?.quantidade_mandados_busca_apreensao_infrator || 0,
  quantidade_alvos_outros_estados:
    props.operacao?.quantidade_alvos_outros_estados || 0,
  quantidade_policiais_empregados:
    props.operacao?.quantidade_policiais_empregados || 0,
  quantidade_viaturas_empregadas:
    props.operacao?.quantidade_viaturas_empregadas || 0,
  ...
  vinculada_delegacia_seccional:
    props.operacao?.vinculada_delegacia_seccional || '',
...
// Mapeamento de campo - (para redirecionar ao step correto após erro)
...
const submit = () => {
  ...
  const onError = errors => {
    // Encontra a etapa que contém algum erro e navega para ela
  ...
  if (isEdit.value) {
    form.put(route('operacoes.update', props.operacao.id), { onError });
  } else {
    form.post(route('operacoes.store'), { onError });
  }
};
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="mt-2 text-sm text-gray-600">
                Preencha todos os campos obrigatórios para registrar a operação
                policial
              </p>
            </div>
        ...
        <div
          ...
          class="mx-6 mb-2 rounded-lg border border-red-200 bg-red-50 p-4"
        >
          ...
          <div class="bg-white shadow rounded-lg p-6">
            ...
            <div v-show="etapaAtual === 5" class="space-y-6">
              ...
              <div>
                ...
                ></textarea>
                <div
                  v-if="erro('solicitacao_apoio_diop')"
                  class="text-red-500 text-sm mt-1"
                >
              ...
              <!-- Resumo final -->
              <div
                class="bg-gray-100 border border-gray-200 rounded-lg p-4 mt-6"
              >
                <h3 class="font-semibold text-neutral-900 mb-2">
                  ✓ Revisão Final
                </h3>
                <p class="text-sm text-neutral-700">
                  Revise todas as informações antes de salvar. Após o envio,
                  você poderá gerar o PDF da operação.
                </p>
              </div>
            </div>
