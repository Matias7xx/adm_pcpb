...
<
<template>
  <Head :title="operacao.nome_operacao" />
        ...
        <div class="bg-white shadow rounded-lg mb-6 p-6">
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex gap-3">
              <Link
                :href="bloqueado ? '#' : route('operacoes.edit', operacao.id)"
                :title="
                  bloqueado
                    ? 'Regularize os resultados pendentes para editar'
                    : 'Editar operação'
                "
                :class="[
        ...
        >
          <div class="flex items-center justify-between">
            ...
            <Link
              ...
              :href="
                route('resultados-operacao.create', {
            ...
            >
              ...
              Visualizar Resultado/Debriefing
            </Link>
          </div>
        </div>
