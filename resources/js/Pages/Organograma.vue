...
<template>
  <div class="bg-gray-100 min-h-screen">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="flex mb-4 text-sm" aria-label="Navegação">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div class="flex items-center">
              ...
              <span class="ml-1 text-gray-500 md:ml-2">Organograma</span>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <div class="mt-8 bg-white shadow-md rounded-lg p-6">
        ...
        <p class="text-gray-600">
          ...
          os níveis de responsabilidade e a distribuição de competências,
          servindo como guia para servidores e cidadãos.
        </p>
      </div>
    </main>
