...
const statusBadge = computed(() => {
  ...
  if (props.veiculo.dias_restantes <= 3) {
    return {
      color: 'bg-orange-500',
      text: `${props.veiculo.dias_restantes} dias restantes`,
    };
  }
      ...
      <CardBox class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div
              class="flex items-center space-x-2 text-gray-900 dark:text-white"
            >
              <svg
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3">
              ...
              <p class="mt-1 text-sm text-yellow-700 dark:text-yellow-300">
                Este documento expirará em {{ veiculo.dias_restantes }} dia{{
                  veiculo.dias_restantes !== 1 ? 's' : ''
                }}.
              </p>
            </div>
          </div>
