            ...
            <div class="border-t border-gray-200 mt-2 pt-2">
              <template v-if="$page.props.auth.user">
                <div class="flex flex-col items-center">
                  <span class="w-full bg-gray-200 text-neutral-900 text-center py-2 px-3 rounded-md text-sm font-medium transition-colors flex items-center justify-center mb-2"
>{{
                    formatName($page.props.auth.user.name)
                  }}</span>
